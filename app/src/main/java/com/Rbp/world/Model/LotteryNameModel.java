package com.Rbp.world.Model;
 ...
 public class LotteryNameModel {
    ...
    private   String lotary_name;
     ...
     public LotteryNameModel(String id, String lotary_name, String details, String logo, String status, double terget_amount, double total_bid, double total_bid_amount, String uploadDate) {
         this.id = id;
