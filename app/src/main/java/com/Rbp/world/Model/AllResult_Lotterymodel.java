package com.Rbp.world.Model;
 ...
 public class AllResult_Lotterymodel {
     ...
     public AllResult_Lotterymodel(String id, String code, double point, String date, String lotary_name, String winner_amount, String prize_number, String note_admin, String winn_status) {
         this.id = id;
         this.code = code;
         this.point = point;
         this.date = date;
