...
public class Transfer_reserve_historyFragment extends Fragment {
    ...
    public Transfer_reserve_historyFragment() {
    ...
    private void loadPlacementList() {
        String placementUrl = mainUrl + "api/app_reserve_balance_transfer_his";
