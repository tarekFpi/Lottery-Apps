...
public class Withdraw_shop_historyFragment extends Fragment {
    ...
    public Withdraw_shop_historyFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view=inflater.inflate(R.layout.fragment_withdraw_shop_history, container, false);
    ...
    private void loadPlacementList() {
        String placementUrl = mainUrl + "api/app_Shop_balance_withdraw_his";
